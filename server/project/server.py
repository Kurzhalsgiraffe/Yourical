...
def index():
    ...
    active_user_count = dao.get_active_user_count()
    domain = request.scheme + '://' + request.host
    return render_template('index.html', current_user=current_user, domain=domain, user_count=user_count, active_user_count=active_user_count)
